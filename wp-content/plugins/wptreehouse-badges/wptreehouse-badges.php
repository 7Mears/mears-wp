...
function wp_treehouse_badges_register_widgets() {
	register_widget( 'Wptreehouse_Badges_Widget' );
}

add_action( 'widgets_init', 'wp_treehouse_badges_register_widgets' );
...
function wptreehouse_badges_refresh_profiles() {
...
add_action( 'wp_ajax_wptreehouse_badges_refresh_profile', 'wptreehouse_badges_refresh_profiles' );
